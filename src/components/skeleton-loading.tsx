const SkeletonLoading = () => {
    return (
        <div className="flex h-[100dvh] bg-[#F0F5FA] overflow-hidden">
            {/* Sidebar - hidden on mobile */}
            <div className="hidden md:block w-16 lg:w-64 bg-white shadow-md animate-pulse shrink-0">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <div className="p-4 md:p-6 w-full h-full overflow-hidden">
                    <div className="bg-white rounded-lg shadow-xl h-full animate-pulse flex flex-col overflow-hidden">
                        {/* Header section */}
